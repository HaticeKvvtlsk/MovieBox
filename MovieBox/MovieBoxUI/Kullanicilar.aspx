<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="Kullanicilar.aspx.cs" Inherits="MovieBoxUI.Kullanicilar" %>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" OnRowDeleting="GridView1_RowDeleting" OnRowCancelingEdit="GridView1_RowCancelingEdit" OnRowEditing="GridView1_RowEditing" OnRowUpdating="GridView1_RowUpdating">
            <Columns>
                ...
                <asp:TemplateField HeaderText="Mail">
                    <ItemTemplate>
                        <asp:Label ID="lblMail" runat="server" Text='<%#Eval("KullaniciMail")%>'></asp:Label>
                    </ItemTemplate>
                    <EditItemTemplate>
                        <asp:TextBox ID="txtMail" runat="server" Text='<%#Eval("KullaniciMail")%>'></asp:TextBox>
                    </EditItemTemplate>
                </asp:TemplateField>
